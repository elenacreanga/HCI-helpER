var applyColourFilter = function (value) {
    ...
    if (value) {
        if (document.getElementById(value)) {
            s.innerHTML = 'body{-webkit-filter:!!;-moz-filter:!!;-ms-filter:!!;-o-filter:!!;filter:!!;}'.replace(/!!/g, 'url(#' + value + ')');
...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
    applyColourFilter(request.value);
});